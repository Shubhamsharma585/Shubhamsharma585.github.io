        ...
        <div id="about" className="about">
            ...
            >
               ...
               <div style={{display:"flex", flexDirection:"row"}}> 
                   <a target="_blank" href="https://drive.google.com/file/d/1GhLXW0ita-TlWxpLLyd2eJp4pJa3rLY2/view?usp=sharing"><h3 style={{marginTop:"3px", fontSize:"20px", color:"white"}}>View Full Resume</h3></a> 
                </div>  
                        </div>                      
                    </div> 
                </Grid>
